...
class LinearSearchVisualizer {
  ...
  initTheme() {
    const savedTheme = localStorage.getItem('fm_theme') || localStorage.getItem('theme') || localStorage.getItem('aniket_theme') || localStorage.getItem('linearsearch_theme') || 'dark';
